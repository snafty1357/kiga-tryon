              ...
              <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-6 sticky top-24">
                ...
                <div className="glass rounded-2xl p-4 animate-in slide-in-from-bottom-4 duration-500">
                  ...
                  >
                    ...
                    {isGenerating ? `画像を生成中... (${cuts.filter(c => c.isGenerating).length > 0 ? cuts.findIndex(c => c.isGenerating) + 1 : 0}/${enabledCuts.length})` : !humanFile ? '画像を生成する ※要キャラクター設定' : `画像を生成する (${enabledCuts.length}カット)`}
                  </button>
